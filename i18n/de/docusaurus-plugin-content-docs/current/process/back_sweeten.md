...
Mead is back sweetened to add sweetness after fermentation is complete. In order to back sweeten mead, it _must_ first be [stabilized](/process/stabilization). Attempting to back sweeten a non-stable mead will not work in most cases.
